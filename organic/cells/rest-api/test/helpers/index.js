...
let testRestApi = require(path.join(process.cwd(), 'index'))
test.plasma = testRestApi.plasma
...
test.variables.REST_API_URL = dna.get('rest.apiUrl')
test.variables.REST_API_ENDPOINT = dna.get('rest.apiEndpoint')
require(path.join(process.cwd(), 'shared/test/restService'))
