...
// Generated on 2021-10-04T01:13:08+05:30
...
export type CreateUserMutationVariables = Exact<{
  payload: CreateUserInputRecordInput
}>

export type CreateUserMutation = {
  createUser?: Maybe<{ user?: Maybe<{ id: string; name: string; status: StatusT }> }>
}
...
export type DeleteUserMutation = { deleteUser?: Maybe<{ deletedUserNodeId?: Maybe<string> }> }
...
export type UpdateUserMutation = {
  updateUser?: Maybe<{ user?: Maybe<{ id: string; name: string; status: StatusT }> }>
}
...
export type ManageUserQueryVariables = Exact<{
  id: Scalars['UUID']
}>

export type ManageUserQuery = {
  user?: Maybe<{
    nodeId: string
    id: string
    name: string
    ...
    role: string
    status: StatusT
    slotsByOwnerIdList: Array<{
      id: string
      name: string
      address?: Maybe<{ [key: string]: unknown }>
      photoUrl?: Maybe<string>
      pricePerHour: any
      slotAmenitiesList: Array<{ amenityId: string; amenity?: Maybe<{ id: string; name: string }> }>
    }>
    vehiclesByOwnerIdList: Array<{
      id: string
      name: string
      status: StatusT
      licensePlate?: Maybe<string>
...
export type ManageVehicleQueryVariables = Exact<{
  id: Scalars['UUID']
}>

export type ManageVehicleQuery = {
  vehicle?: Maybe<{
    id: string
    name: string
    status: StatusT
...
/**
 * __useManageUserQuery__
 *
 * To run a query within a React component, call `useManageUserQuery` and pass it any options that fit your needs.
 * When your component renders, `useManageUserQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useManageUserQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useManageUserQuery(
  baseOptions?: Apollo.QueryHookOptions<ManageUserQuery, ManageUserQueryVariables>,
) {
  return Apollo.useQuery<ManageUserQuery, ManageUserQueryVariables>(ManageUserDocument, baseOptions)
}
export function useManageUserLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ManageUserQuery, ManageUserQueryVariables>,
) {
  return Apollo.useLazyQuery<ManageUserQuery, ManageUserQueryVariables>(
    ManageUserDocument,
    baseOptions,
  )
}
export type ManageUserQueryHookResult = ReturnType<typeof useManageUserQuery>
export type ManageUserLazyQueryHookResult = ReturnType<typeof useManageUserLazyQuery>
export type ManageUserQueryResult = Apollo.QueryResult<ManageUserQuery, ManageUserQueryVariables>
...
export const ManageVehicleDocument = gql`
...
/**
 * __useManageVehicleQuery__
 *
 * To run a query within a React component, call `useManageVehicleQuery` and pass it any options that fit your needs.
 * When your component renders, `useManageVehicleQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useManageVehicleQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useManageVehicleQuery(
  baseOptions?: Apollo.QueryHookOptions<ManageVehicleQuery, ManageVehicleQueryVariables>,
) {
  return Apollo.useQuery<ManageVehicleQuery, ManageVehicleQueryVariables>(
    ManageVehicleDocument,
    baseOptions,
  )
}
export function useManageVehicleLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ManageVehicleQuery, ManageVehicleQueryVariables>,
) {
  return Apollo.useLazyQuery<ManageVehicleQuery, ManageVehicleQueryVariables>(
    ManageVehicleDocument,
    baseOptions,
  )
}
export type ManageVehicleQueryHookResult = ReturnType<typeof useManageVehicleQuery>
export type ManageVehicleLazyQueryHookResult = ReturnType<typeof useManageVehicleLazyQuery>
export type ManageVehicleQueryResult = Apollo.QueryResult<
  ManageVehicleQuery,
  ManageVehicleQueryVariables
>
